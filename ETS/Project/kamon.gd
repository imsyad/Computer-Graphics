...
func kamon_inner_arch(
	...
	for i in range (rx/4, rx):
		draw_midpoint_ellipse(centre0, i, ry, 0 + degree_rotation, color)
		draw_midpoint_ellipse(centre0, i, ry, 180 + degree_rotation, color)
	
	for i in range (rx/4, rx):
		draw_midpoint_ellipse(centre1, i, ry, 120 + degree_rotation, color)
		draw_midpoint_ellipse(centre1, i, ry, 300 + degree_rotation, color)
	
	for i in range (rx/4, rx):
		draw_midpoint_ellipse(centre2, i, ry, 240 + degree_rotation, color)
		draw_midpoint_ellipse(centre2, i, ry, 420 + degree_rotation, color)
