...
# Fungi untuk menggambar sebuah lingkaran dengan warna dasar hitam sebagai 
# dasar dari kamon.
func dasar_kamon(centre:Vector2, radius, warna):
	draw_circle(centre, radius, warna)


# Fungi untuk menggambar 3 buah kelopak kamon
...
# Fungsi untuk menggambar lingkaran kecil pada pusat kamon.
...
# Fungsi untuk menggambar outline/garis luar kamon.
